...
import frc.robot.subsystems.drive.AdvancedSwerveKinematics.ControlCentricity;
import frc.robot.subsystems.drive.SwerveModule.SwerveModuleBuilder;
...
public class DriveSubsystem extends SubsystemBase {
  ...
  private final AdvancedSwerveKinematics advancedSwerveKinematics = new AdvancedSwerveKinematics();
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative) {
    ...
    SwerveModuleState[] swerveModuleStates =
        advancedSwerveKinematics.toSwerveModuleStates(
            xSpeed,
            ySpeed,
            rot,
            getHeading(),
            fieldRelative ? ControlCentricity.FIELD_CENTRIC : ControlCentricity.ROBOT_CENTRIC);
